...
def parse_args():
    ...
    parser.add_argument("--job_dir", default="/home/csci8980/veera047/yolo-tests/detr/run1/", type=str, help="Job dir. Leave empty for automatic.")
...
def get_shared_folder() -> Path:
    ...
    #     return p
    p = Path('/home/csci8980/veera047/yolo-tests/detr/run1/checkpoint/')
    p.mkdir(exist_ok=True)
    return p
